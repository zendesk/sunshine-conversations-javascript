    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('recentNotifications')) {
                obj['recentNotifications'] = ApiClient.convertToType(data['recentNotifications'], [Message]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:sunshine-conversations-client/sunshine-conversations-client.model/Message>} recentNotifications
 */
