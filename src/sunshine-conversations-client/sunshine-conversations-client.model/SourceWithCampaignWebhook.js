...
import SourceWithCampaignWebhookAllOf from './SourceWithCampaignWebhookAllOf';
...
class SourceWithCampaignWebhook {
     ...
     */
    constructor() { 
        SourceWebhook.initialize(this);SourceWithCampaignWebhookAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            SourceWebhook.constructFromObject(data, obj);
            SourceWithCampaignWebhookAllOf.constructFromObject(data, obj);
...
export default SourceWithCampaignWebhook;
