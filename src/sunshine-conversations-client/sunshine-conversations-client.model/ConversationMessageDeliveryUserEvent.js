...
import ConversationMessageDeliveryChannelEventAllOf from './ConversationMessageDeliveryChannelEventAllOf';
...
class ConversationMessageDeliveryUserEvent {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);ConversationMessageDeliveryChannelEventAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ConversationMessageDeliveryChannelEventAllOf.constructFromObject(data, obj);
