    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('user')) {
                obj['user'] = ApiClient.convertToType(data['user'], User2);
            }
        }
        return obj;
    }
...
/**
     ...
     * @param {module:sunshine-conversations-client/sunshine-conversations-client.model/User2} user The user that authored the message or activity. `profile` is included in the payload if the `includeFullUser` option is enabled.
     */
    setUser(user) {
        this['user'] = user;
    }
 ...
 * @member {module:sunshine-conversations-client/sunshine-conversations-client.model/User2} user
 */
