...
import ConversationCreateEventAllOf from './ConversationCreateEventAllOf';
...
class ConversationCreateEvent {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);ConversationCreateEventAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ConversationCreateEventAllOf.constructFromObject(data, obj);
