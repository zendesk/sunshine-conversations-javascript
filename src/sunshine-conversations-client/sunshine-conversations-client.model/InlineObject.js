...
class InlineObject {
     ...
     * @param code {String} The authorization code received via the OAuth flow
     * @param grantType {String} Must be set to the string `authorization_code`
     * @param clientId {String} Your OAuth client ID, provisioned during the partner application process
     * @param clientSecret {String} Your OAuth client secret, provisioned during the partner application process
     */
...
/**
     * Returns The authorization code received via the OAuth flow
     * @return {String}
     */
    getCode() {
        return this.code;
    ...
    /**
     * Sets The authorization code received via the OAuth flow
     * @param {String} code The authorization code received via the OAuth flow
     */
    setCode(code) {
        this['code'] = code;
    }
...
/**
     * Returns Your OAuth client ID, provisioned during the partner application process
     * @return {String}
     */
    getClientId() {
    ...
    /**
     * Sets Your OAuth client ID, provisioned during the partner application process
     * @param {String} clientId Your OAuth client ID, provisioned during the partner application process
     */
    setClientId(clientId) {
        this['client_id'] = clientId;
    }
/**
     * Returns Your OAuth client secret, provisioned during the partner application process
     * @return {String}
     */
    getClientSecret() {
    ...
    /**
     * Sets Your OAuth client secret, provisioned during the partner application process
     * @param {String} clientSecret Your OAuth client secret, provisioned during the partner application process
     */
