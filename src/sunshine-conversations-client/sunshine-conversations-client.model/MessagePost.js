...
class MessagePost {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('messageSchema')) {
                obj['messageSchema'] = ApiClient.convertToType(data['messageSchema'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {String} messageSchema
 */
MessagePost.prototype['messageSchema'] = undefined;
