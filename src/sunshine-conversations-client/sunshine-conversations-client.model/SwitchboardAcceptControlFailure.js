...
import SwitchboardAcceptControlFailureAllOf from './SwitchboardAcceptControlFailureAllOf';
...
class SwitchboardAcceptControlFailure {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);SwitchboardAcceptControlFailureAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            SwitchboardAcceptControlFailureAllOf.constructFromObject(data, obj);
