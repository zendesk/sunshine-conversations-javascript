...
import ConversationReadEventAllOf from './ConversationReadEventAllOf';
...
class ConversationReadEvent {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);ConversationReadEventAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ConversationReadEventAllOf.constructFromObject(data, obj);
