...
class IntegrationUpdate {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('canUserCreateConversation')) {
                obj['canUserCreateConversation'] = ApiClient.convertToType(data['canUserCreateConversation'], 'Boolean');
            }
...
/**
     ...
     * @return {Boolean}
     */
    getCanUserCreateConversation() {
        return this.canUserCreateConversation;
    }

    /**
     * Sets Allows users to create more than one conversation on the web messenger integration.
     * @param {Boolean} canUserCreateConversation Allows users to create more than one conversation on the web messenger integration.
     */
    setCanUserCreateConversation(canUserCreateConversation) {
 ...
 * @member {Boolean} canUserCreateConversation
 */
IntegrationUpdate.prototype['canUserCreateConversation'] = undefined;
 ...
 * @member {Boolean} canUserCreateConversation
 */
AndroidUpdate.prototype['canUserCreateConversation'] = undefined;
 ...
 * @member {Boolean} canUserCreateConversation
 */
IosUpdate.prototype['canUserCreateConversation'] = undefined;
 ...
 * @member {Boolean} canUserCreateConversation
 */
WebUpdate.prototype['canUserCreateConversation'] = undefined;
