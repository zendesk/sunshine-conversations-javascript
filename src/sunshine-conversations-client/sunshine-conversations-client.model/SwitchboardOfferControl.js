...
import SwitchboardOfferControlAllOf from './SwitchboardOfferControlAllOf';
...
class SwitchboardOfferControl {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);SwitchboardOfferControlAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            SwitchboardOfferControlAllOf.constructFromObject(data, obj);
