...
import MatchCriteriaTwilioAllOf from './MatchCriteriaTwilioAllOf';
...
class MatchCriteriaTwilio {
    ...
    constructor(type, integrationId, phoneNumber) { 
        MatchCriteriaBase.initialize(this, type, integrationId);MatchCriteriaTwilioAllOf.initialize(this, phoneNumber);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            MatchCriteriaTwilioAllOf.constructFromObject(data, obj);
