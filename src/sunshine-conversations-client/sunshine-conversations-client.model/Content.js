...
class Content {
     ...
     */
    constructor(type, items, fields) { 
        TextMessage.initialize(this, type);CarouselMessage.initialize(this, type, items);FileMessage.initialize(this, type);FormMessage.initialize(this, type, fields);FormResponseMessage.initialize(this, type, fields);ImageMessage.initialize(this, type);ListMessage.initialize(this, type, items);LocationMessage.initialize(this, type);
        Content.initialize(this, type, items, fields);
    }
     ...
     */
    static initialize(obj, type, items, fields) { 
        obj['type'] = type;
        obj['items'] = items;
        obj['fields'] = fields;
    }
