...
import ConversationPostbackEventAllOf from './ConversationPostbackEventAllOf';
...
class ConversationPostbackEvent {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);ConversationPostbackEventAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ConversationPostbackEventAllOf.constructFromObject(data, obj);
