...
import ClientAddEventAllOf from './ClientAddEventAllOf';
...
class ClientAddEvent {
     ...
     */
    constructor() { 
        EventSubSchema.initialize(this);ClientAddEventAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ClientAddEventAllOf.constructFromObject(data, obj);
